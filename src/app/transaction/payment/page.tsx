      ...
      <div className="bg-white lg:grid lg:grid-cols-[2fr_1fr] relative ">
          ...
          <div className="flex flex-col justify-start items-start w-full gap-8">
            ...
            <Card className="w-full h-full p-3">
              <CardHeader>
                <h1 className="font-bold text-2xl">
                  Payment Method : {paymentMethod === 'E_WALLET' ? 'E-WALLET' : ''} {paymentMethod === 'BANK_TRANSFER' ? 'Bank Transfer' : ''} {paymentMethod === 'CREDIT_CARD' ? 'Credit Card' : ''}
                </h1>
            ...
            <div className="w-full h-full">
              ...
              <div>
                <Card className="w-full h-full p-3">
                  <CardHeader>
                    <h1 className="text-xl font-bold">Upload your proof of payment here:</h1>
                  </CardHeader>
                  <CardContent>
                    <Form {...form}>
        ...
        <div className="w-full h-full relative px-5 lg:px-0 py-8 lg:py-0">
            ...
            <Card className="p-3">
              ...
              <CardContent className="flex flex-col gap-3 py-2">
                <div className="text-sm">
                  ...
                  <li> Select your preferred e-wallet (e.g., GoPay, OVO, Dana).</li>
                  <li>Confirm the payment amount.</li>
                  <li> Send the exact amount to the e-wallet address provided.</li>
                  <li>Upload the proof of payment.</li>
                  <li>Wait for the confirmation message. Admin will confirm.</li>
                </div>
              </CardContent>
            </Card>
          ) : (
          ...
          {paymentMethod === 'BANK_TRANSFER' ? (
            <Card className="p-3">
              <CardHeader>
                <h1 className="text-lg font-bold">How to pay with Bank Transfer:</h1>
              </CardHeader>
              <CardContent className="flex flex-col gap-3 py-2">
                <div className="text-sm">
                  <li>Select “Bank Transfer” as the payment method during checkout.</li>
                  <li> Note the bank account number or transfer details provided.</li>
          ...
          {paymentMethod === 'CREDIT_CARD' ? (
            <Card className="p-3">
              <CardHeader>
                <h1 className="text-lg font-bold">How to pay with Credit Card:</h1>
              </CardHeader>
              <CardContent className="flex flex-col gap-3 py-2">
                <div className="text-sm">
